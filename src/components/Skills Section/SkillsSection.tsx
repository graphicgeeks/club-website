...
export function SkillsSection() {
  ...
  //     icon: Brain,
  //     description:
  //       "Artificial Intelligence and Machine Learning solutions for real-world problems",
  //     technologies: [
  //       "Python",
  //       "TensorFlow",
  //       "PyTorch",
  ...
  //     icon: Video,
  //     description:
  //       "Professional video editing and motion graphics for digital content",
  //     technologies: [
  //       "Adobe Premiere",
  //       "After Effects",
  //       "DaVinci Resolve",
  ...
  //     icon: PenTool,
  //     description:
  //       "Technical writing, blogging, and content creation for digital platforms",
  //     technologies: [
  //       "SEO Writing",
  //       "Technical Docs",
  //       "Blog Writing",
  ...
  return (
    <section
      id="skills"
      className="py-20 bg-gradient-to-br from-primary-light/10 via-background to-accent/5"
    >
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Develop cutting-edge skills that are in high demand in today's
        ...
        <div className="bg-gradient-to-r from-primary/5 via-primary/10 to-primary/5 rounded-3xl p-8 md:p-12">
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold mb-6 text-foreground">
              Why Join Our Skill Development Program?
            </h3>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Get access to comprehensive training, mentorship, and real-world
              project experience
            </p>
          </div>
